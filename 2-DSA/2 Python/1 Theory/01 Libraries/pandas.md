...
6. Pandas : Data cleaning
    ...
    - Removing Rows :
        ...
        ```
    - `duplicated()` : Returns True for every row that is a duplicate, otherwise False:
...
7. `corr()` : The corr() method calculates the relationship between each column in your data set.
    - Its value lies between -1 to 1, the value near to 1 or -1 mean correlation is good, else bad
