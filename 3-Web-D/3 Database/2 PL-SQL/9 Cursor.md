...
- 2 type of cursors :
    ...
    - **Implicit** : automatically generated by Oracle while an SQL statement is executed like when `INSERT`, `UPDATE`, `DELETE` etc are executed
        - Oracle provides these cursor attributes to check DML operations : `%FOUND`, `%NOTFOUND`, `%ROWCOUNT` & `%ISOPEN`
